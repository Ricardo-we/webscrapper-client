...
export default class BaseRequest {
    ...
    public async post(payload: PayloadTypes, { routeParams = "", ...requestConfig }: RequestConfig) {
        try {
            const fullUrl = this.endpointUrl + routeParams
    ...
    public async destroy({ routeParams = "", ...requestConfig }: RequestConfigParamsRequired) {
        try {
            const fullUrl = this.endpointUrl + routeParams
    ...
    public async update(payload: PayloadTypes, { routeParams = "", ...requestConfig }: RequestConfigParamsRequired) {
        try {
            const fullUrl = this.endpointUrl + routeParams
            const response = await axios.post(fullUrl, payload, requestConfig)
            return response.data
